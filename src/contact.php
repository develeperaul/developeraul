...
$subject ="Новая заявка с сайта developeraul.ru";
...
$header .= "From: Новая заявка <developeraul@gmail.com>\n\n";	
$mail = mail("developeraul@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
